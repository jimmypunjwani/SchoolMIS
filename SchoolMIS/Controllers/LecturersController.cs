...
namespace SchoolMIS.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "LecturerID,LastName,FirstName")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "LecturerID,LastName,FirstName")] Lecturer lecturer)
        {
            if (ModelState.IsValid)
            {
